...
[Errata Page](https://www.oreilly.com/catalog/errata.csp?isbn=0636920252207)

## Elogios por la tercera edición de Head First Python

“Python existe desde 1991, pero últimamente ha experimentado un resurgimiento masivo debido al aprendizaje automático y los entornos Jupyter. Dado que este lenguaje ha cambiado a lo largo de muchos años, puede resultar abrumador saber cómo empezar. Head First Python no solo le brinda lo básico, sino que también elimina todo lo innecesario. Disfrutará desarrollando una aplicación del mundo real con una historia divertida del mundo real mientras crea cuadernos e implementa una aplicación viable en la web. Si Python está en tu lista de tareas pendientes, ¡comienza con este libro!

—Daniel Hinojosa, desarrollador/instructor/presentador

"Un excelente comienzo en el poderoso lenguaje de codificación Python, que lo llevará a un viaje educativo e intrigante para crear una aplicación desde el concepto hasta una aplicación web en vivo".

—Michael Hopkins, P.Geo., PMP

“Head First Python proporciona una experiencia de aprendizaje atractiva que se siente como si un tutor amigable y experto lo guiara personalmente. Con un equilibrio perfecto entre contenido entretenido e informativo, este libro hace que aprender Python sea divertido y eficaz”.

—William Jamir Silva, Anaconda, Inc., ingeniero de software

“Una forma divertida de aprender a codificar con Python, utilizando las mismas herramientas de desarrollo que mis colegas usan en el día a día. El libro incluye una progresión de desafíos que me llevaron a resolver problemas que no podría haber abordado al principio. Proporciona una introducción escasa y valiosa a la codificación 'Pythonic' que reconoce que hay 'más de una manera de hacerlo'”.

—Dave Marsden, arquitecto de la nube, CTS

## Table of Contents (the real thing)

### [00 Cómo utilizar este libro: Introducción](https://github.com/adolfodelarosades/Python/blob/main/temarios/001-Head-First-Python/00-Introduction.md) :+1:
