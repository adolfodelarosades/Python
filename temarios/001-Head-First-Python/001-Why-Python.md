...
for suit in suits:
    for card in faces + numbered:
        barajaList.append((card, "of", suit))
        barajaSet.add((card, "of", suit))

len(barajaList)
len(barajaSet)

for id, carta in enumerate(barajaList):
    print(id + 1, ".-", carta)

for id, carta in enumerate(barajaSet):
    print(id + 1, ".-", carta)

def dibujarBaraja():
    carta = random.choice(list(barajaSet))
    barajaSet.remove(carta)
    return carta

for _ in range(len(barajaSet)):
    print(len(barajaSet),  ".- ",  dibujarBaraja())
```
...
<img width="1512" alt="image" src="https://github.com/adolfodelarosades/Python/assets/23094588/9c4b04a1-471a-4441-b3c5-674660c5790e">
...
La impresión de la lista se hace tal y como se fue llenando.

Si imprimimos el conjunto tenemos:

<img width="1512" alt="image" src="https://github.com/adolfodelarosades/Python/assets/23094588/09eea475-96cb-42cf-81b4-4eb816309271">
...
El conjunto se lista de esta forma no importa las veces que lo ejecutemos.

Para recuperar aleatoriamente cartas de la baraja usamos la función **`dibujarBaraja`**.

<img width="1512" alt="image" src="https://github.com/adolfodelarosades/Python/assets/23094588/397c2a5e-3c97-4ab1-a65b-6c200968ddc7">
...
Si ejecuto nuevamente la salida será completamente diferente.
